...
public class ControlaFabricante {
   ...
   public static void main(String[] args) {
       ...
       Produto p1 = new Produto("P01", "Teclado K120", 89.90);
       Produto p2 = new Produto("P02", "Monitor 27pol", 1250.00);
       ...
       do {
           ...
           switch (opcao) {
               ...
               case 2:
                   ...
                   scanner.nextLine();
                   listaGeralProdutos.add(new Produto(codProd, nomeProd, preco));
               ...
               case 3:
                   ...
                   Produto prodAlvo = buscarProdutoPorCodigo(listaGeralProdutos, codAlvo);
                   if (prodAlvo == null) {
               ...
               case 4:
                   ...
                   Produto prodDesvincular = buscarProdutoPorCodigo(listaGeralProdutos, codDesvincular);
               ...
               case 6:
                   ...
                   if (listaGeralProdutos.isEmpty()) {
                       ...
                       for (Produto p : listaGeralProdutos) {
